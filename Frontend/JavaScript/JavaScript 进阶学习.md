...
>
>   ![image-20210630191828124](https://xingqiu-tuchuang-1256524210.cos.ap-shanghai.myqcloud.com/2767/image-20210630191828124.png) 
>
...
>  * 栈: 全局变量/局部变量
>  * 堆: 对象
>  * <img src="https://xingqiu-tuchuang-1256524210.cos.ap-shanghai.myqcloud.com/2767/image-20210630192130518.png" alt="image-20210630192130518" style="zoom:50%;" />  
...
>
>   * ![image-20210705185535337](https://xingqiu-tuchuang-1256524210.cos.ap-shanghai.myqcloud.com/2767/image-20210705185535337.png)  
>
>5. 代码示例
>
>   ```js
 ...
 * ![image-20210714201049312](https://xingqiu-tuchuang-1256524210.cos.ap-shanghai.myqcloud.com/2767/image-20210714201049312.png)
2. 给原型对象添加属性(`一般都是方法`)
...
4. 内存结构
  ...
  ![image-20210714203043314](https://xingqiu-tuchuang-1256524210.cos.ap-shanghai.myqcloud.com/2767/image-20210714203043314.png) 
 ...
 * 访问一个对象的属性时，
   ...
   * 如果最终没找到, 返回undefined
     ...
     ![image-20210714210912653](https://xingqiu-tuchuang-1256524210.cos.ap-shanghai.myqcloud.com/2767/image-20210714210912653.png)
...
1. ```js
  ...
  ![image-20210714212928432](https://xingqiu-tuchuang-1256524210.cos.ap-shanghai.myqcloud.com/2767/image-20210714212928432.png) 

2. ```js
    function Foo(){  }

 ![image-20210714212945164](https://xingqiu-tuchuang-1256524210.cos.ap-shanghai.myqcloud.com/2767/image-20210714212945164.png) 
...
![image-20210723173855550](https://xingqiu-tuchuang-1256524210.cos.ap-shanghai.myqcloud.com/2767/image-20210723173855550.png)
...
>
> <img src="https://xingqiu-tuchuang-1256524210.cos.ap-shanghai.myqcloud.com/2767/image-20210723181727823.png" alt="image-20210723181727823" style="zoom:80%;" /> 
...
>```
>
>![image-20210723183046182](https://xingqiu-tuchuang-1256524210.cos.ap-shanghai.myqcloud.com/2767/image-20210723183046182.png)
>
>此处用一个动态图来展示:
>
>![](https://xingqiu-tuchuang-1256524210.cos.ap-shanghai.myqcloud.com/2767/%E6%89%A7%E8%A1%8C%E6%A0%88%E4%B8%8E%E4%BA%8B%E4%BB%B6%E9%98%9F%E5%88%97.gif)
>
>举个栗子:  
>
>```js
...
> * 函数上下文环境==>对应的函数使用域
>
>![image-20210727141319410](https://xingqiu-tuchuang-1256524210.cos.ap-shanghai.myqcloud.com/2767/image-20210727141319410.png)
...
>```
>
>![image-20210726192714660](https://xingqiu-tuchuang-1256524210.cos.ap-shanghai.myqcloud.com/2767/image-20210726192714660.png)
